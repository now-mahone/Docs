...
# Define Member Combinations
member_options = [
    "Scofield", "Abruzzi", "Mahone", "Bagwell",
    "Scofield & Abruzzi", "Scofield & Mahone", "Scofield & Bagwell",
    "Abruzzi & Mahone", "Abruzzi & Bagwell", "Mahone & Bagwell",
    "Scofield, Abruzzi & Mahone", "Scofield, Abruzzi & Bagwell",
    "Scofield, Mahone & Bagwell", "Abruzzi, Mahone & Bagwell",
    "Everyone"
]

# Data Validation for Members
members_dv = DataValidation(type="list", formula1='"' + ','.join(member_options) + '"', allow_blank=True)
...
colors = {
    "Scofield": "C9DAF8", # Blue
    "Abruzzi": "FFF2CC", # Yellow
    "Mahone": "F4CCCC", # Red
    "Bagwell": "FCE5CD", # Orange
    "Scofield & Abruzzi": "D9EAD3", # Green (Blue + Yellow)
    "Scofield & Mahone": "D9D2E9", # Purple (Blue + Red)
    "Scofield & Bagwell": "E6B8AF", # Light Brown (Blue + Orange)
    "Abruzzi & Mahone": "F9CB9C", # Peach (Yellow + Red)
    "Abruzzi & Bagwell": "FFE599", # Gold (Yellow + Orange)
    "Mahone & Bagwell": "EA9999", # Dark Red (Red + Orange)
    "Scofield, Abruzzi & Mahone": "A2C4C9", # Teal (3 members)
    "Scofield, Abruzzi & Bagwell": "A2C4C9",
    "Scofield, Mahone & Bagwell": "A2C4C9",
    "Abruzzi, Mahone & Bagwell": "A2C4C9",
    "Everyone": "EFEFEF" # Grey
}

for member, color in colors.items():
    fill = PatternFill(start_color=color, end_color=color, fill_type="solid")
    ws.conditional_formatting.add(f"B2:B{len(raw_tasks)+1}", CellIsRule(operator='equal', formula=[f'"{member}"'], fill=fill))
...
wb.save("Kerne_Weekend_Kanban_Feb21_22.xlsx")
print("Successfully generated Kerne_Weekend_Kanban_Feb21_22.xlsx")