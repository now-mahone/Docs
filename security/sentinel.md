...
### 3. Circuit Breakers
Sentinel has the authority to pause protocol operations if it detects abnormal on-chain activity or CEX API instability. This "Guardian" role is hardcoded into the core smart contracts to ensure sub-second response times.
