...
### 3. Governance Forum Presence
Kerne maintains active presence on:
- **Ethereum Research** (ethresear.ch) — Publishing mechanism design papers
- **Base Governance** — Proposing liquidity incentive programs
- **Aerodrome/Curve Forums** — Negotiating gauge allocations and bribes
...
| Metric | Target |
|--------|--------|
| CT Impressions | 5M+/month |
| Discord Members | 50K+ by TGE |
