...
class PoRAttestationBot:
    ...
    def get_total_protocol_assets(self):
        ...
        total_assets = self.w3.from_wei(on_chain_assets, 'ether') + Web3.to_poly(off_chain_equity) # Simplified for mock
    ...
    def generate_solvency_report(self):
        ...
        solvency_ratio = (total_assets / total_liabilities * 100) if total_liabilities > 0 else 100.0
        ...
        report = {
            ...
            "solvency_ratio": f"{solvency_ratio:.2f}%",
            "status": status
        }
        ...
        with open(report_path, "w") as f:
            f.write(f"# Kerne Solvency Report - {report['date']}\n\n")
            f.write(f"**Status:** {status}\n\n")
            f.write(f"- **Total Assets:** {total_assets:.4f} ETH-equiv\n")
            f.write(f"- **Total Liabilities:** {total_liabilities:.4f} ETH-equiv\n")
            f.write(f"- **Solvency Ratio:** {report['solvency_ratio']}\n")
            f.write(f"- **Vault:** `{self.vault_address}`\n\n")
