// Created: 2026-01-14 | Monochrome: 2026-01-22
'use client';
        ...
        <section className="py-24 bg-white border-b border-[#000000]">
          <div className="max-w-7xl mx-auto px-6 md:px-12 text-[#000000] font-medium leading-relaxed space-y-20">
            ...
            <div>
              ...
              {/* Yield Composition Model Component - Stretched to full grid width */}
                ...
                <div className="space-y-16">
                  <div className="space-y-6">
                    <div className="h-3 bg-[#ffffff] rounded-full overflow-hidden">
                      <div className="h-full bg-[#000000] w-[25%] rounded-full shadow-[0_0_15px_rgba(76,123,231,0.2)]"></div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="h-3 bg-[#ffffff] rounded-full overflow-hidden">
                      <div className="h-full bg-[#000000] w-[75%] rounded-full shadow-[0_0_15px_rgba(76,123,231,0.2)]"></div>
                    </div>
                    <div className="flex justify-between items-center text-l">
            ...
            {/* 5. Recursive Leverage Engine (Folding) */}
            <div>
            ...
            {/* 7. Institutional Onboarding Protocol */}
            <div>
