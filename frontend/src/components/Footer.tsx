      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center">
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 w-full text-left">
          ...
          <div className="flex flex-col gap-6">
            ...
            <a href="https://documentation.kerne.ai" target="_blank" rel="noopener noreferrer" className="text-[#ffffff] font-medium hover:text-[#000000/10] transition-colors text-s">Documentation</a>
          </div>
          <div className="flex flex-col gap-6">
