...
Kerne is designed as a modular suite of smart contracts and offchain engines that work in harmony to maintain a delta neutral position while extracting maximum yield.
...
A high performance Python engine that monitors onchain events and manages the CEX based short positions to maintain delta neutrality.
