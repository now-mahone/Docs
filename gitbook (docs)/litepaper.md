...
Kerne implements a **tiered performance fee structure** designed to reward early adopters and bootstrap TVL velocity.

### Launch Promotion: 0% Performance Fee
...
**Early adopters capture 100% of generated yield.** There are no fixed management fees, subscription costs, or entry/exit penalties for primary users.

Once the protocol surpasses $100,000 TVL, a standard performance fee applies only to the net yield generated by the strategy — guaranteeing complete alignment between the protocol's revenue and the allocator's capital results.
