...
- **Multisig Custody**: All institutional deposits are managed via Gnosis Safe with configurable signer thresholds.

### Supported Custodians
- **Fireblocks** — API integrated for automated workflow
- **Coinbase Prime** — Native Base chain support
- **Gnosis Safe** — Onchain multisig for DAOs
...
6. **Ongoing Monitoring**: Realtime dashboard access + scheduled reporting.
...
| Sovereign | $10M+ | Negotiable | Custom parameters, direct team access, coinvestment rights |
